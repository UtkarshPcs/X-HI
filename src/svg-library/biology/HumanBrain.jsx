...
export default function HumanBrain({ data }) {
  ...
  return (
    <svg viewBox="0 0 500 500" style={{ width: '100%', height: 'auto', maxWidth: '400px' }} xmlns="http://www.w3.org/2000/svg">
      ...
      {showLabels && pointerCount === 0 && (
        <g id="labels">
          <text x="100" y="70" fill="currentColor" fontSize="16">Cerebrum</text>
          <line x1="250" y1="135" x2="150" y2="80" stroke="currentColor" />
          
          <text x="80" y="255" fill="currentColor" fontSize="16">Cerebellum</text>
          <line x1="250" y1="250" x2="150" y2="250" stroke="currentColor" />
          
          <text x="100" y="430" fill="currentColor" fontSize="16">Medulla</text>
