...
export default function MirrorSignConvention({ data }) {
  ...
  return (
    <svg viewBox="0 0 500 500" width="100%" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Mirror (Concave for example) */}
      <path d="M 250 100 Q 180 250 250 400" fill="none" stroke={getStroke('mirror', '#555')} strokeWidth={getStrokeWidth('mirror', 4)} />
      ...
      {showLabels && (
        <g id="labels" fontSize="14" fontFamily="sans-serif" fill="#333">
          ...
          <text x="260" y="265" fill={getStroke('pole')}>P (0,0)</text>
