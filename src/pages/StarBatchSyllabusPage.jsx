  ...
  return (
    <div style={{ animation: 'fade-in 0.4s ease' }}>
      <style>{`
        ...
        .sb-back-btn { background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); color: #fff; border-radius: 8px; padding: 0.5rem; cursor: pointer; display: flex; align-items: center; transition: all 0.2s; }
        ...
        .sb-crumb-btn { background: none; border: none; color: #fbbf24; cursor: pointer; padding: 0.2rem 0.4rem; border-radius: 4px; font-size: 0.9rem; transition: background 0.2s; }
        .sb-crumb-btn:hover { background: rgba(251, 191, 36, 0.1); }
        .sb-crumb-current { color: rgba(255,255,255,0.6); padding: 0.2rem 0.4rem; }
        .sb-crumb-sep { color: rgba(255,255,255,0.3); }
        .sb-row { background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.07); border-radius: 12px; padding: 1.1rem 1.25rem; margin-bottom: 0.75rem; display: flex; align-items: center; justify-content: space-between; cursor: pointer; transition: all 0.2s; width: 100%; text-align: left; color: #fff; }
        .sb-row:hover { background: rgba(251, 191, 36, 0.05); border-color: rgba(251, 191, 36, 0.25); }
        ...
        .sb-chapter-header { padding: 1.1rem 1.25rem; display: flex; align-items: center; justify-content: space-between; cursor: pointer; transition: background 0.2s; }
        .sb-chapter-header:hover { background: rgba(251, 191, 36, 0.04); }
        .sb-chapter-title { display: flex; align-items: center; gap: 0.7rem; color: #cbd5e1; font-size: 0.95rem; font-weight: 500; }
        .sb-chapter-actions { display: flex; align-items: center; gap: 0.5rem; }
        .sb-add-btn { background: rgba(251, 191, 36, 0.1); border: 1px solid rgba(251, 191, 36, 0.25); color: #fbbf24; border-radius: 6px; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: all 0.2s; }
        .sb-add-btn:hover { background: #fbbf24; color: #000; }
        .sb-questions-panel { border-top: 1px solid rgba(255,255,255,0.05); padding: 1rem 1.25rem 1.25rem; display: flex; flex-direction: column; gap: 0.8rem; }
        .sb-q-card { background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.06); border-radius: 8px; padding: 0.9rem 1rem; }
        .sb-q-topic { font-weight: 600; color: #fbbf24; font-size: 0.9rem; margin-bottom: 0.5rem; display: flex; justify-content: space-between; align-items: flex-start; }
        .sb-q-author { font-size: 0.72rem; color: rgba(255,255,255,0.35); font-weight: 400; }
        .sb-q-text { color: #e2e8f0; font-size: 0.88rem; line-height: 1.55; white-space: pre-wrap; }
        .sb-q-img { max-width: 100%; border-radius: 6px; margin-top: 0.8rem; border: 1px solid rgba(255,255,255,0.1); }
        .sb-empty { color: rgba(255,255,255,0.3); font-size: 0.85rem; font-style: italic; text-align: center; padding: 0.5rem 0; }
        
        /* Modal */
        .sb-overlay { position: fixed; inset: 0; background: rgba(0,0,0,0.8); backdrop-filter: blur(8px); display: flex; align-items: center; justify-content: center; z-index: 9999; padding: 1rem; }
        .sb-modal { background: #0e1117; border: 1px solid rgba(251, 191, 36, 0.25); border-radius: 18px; width: 100%; max-width: 490px; padding: 1.75rem; box-shadow: 0 30px 60px rgba(0,0,0,0.5); max-height: 90vh; overflow-y: auto; }
        ...
        .sb-field { width: 100%; background: rgba(0,0,0,0.4); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 0.8rem 1rem; color: #fff; outline: none; transition: border-color 0.2s; box-sizing: border-box; margin-bottom: 1rem; font-size: 0.95rem; }
        ...
        .sb-file-label { display: flex; align-items: center; justify-content: center; gap: 0.6rem; background: rgba(255,255,255,0.03); border: 1px dashed rgba(255,255,255,0.15); border-radius: 10px; padding: 0.9rem; cursor: pointer; color: rgba(255,255,255,0.5); font-size: 0.9rem; transition: all 0.2s; margin-bottom: 1rem; }
        .sb-file-label:hover { border-color: #fbbf24; color: #fbbf24; background: rgba(251,191,36,0.04); }
        .sb-submit-btn { width: 100%; background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%); color: #000; border: none; border-radius: 10px; padding: 0.9rem; font-weight: 600; font-size: 0.95rem; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 0.5rem; transition: all 0.2s; }
        ...
        .sb-error { background: rgba(248,113,113,0.1); border: 1px solid rgba(248,113,113,0.2); color: #fca5a5; border-radius: 8px; padding: 0.6rem 0.9rem; font-size: 0.85rem; margin-bottom: 1rem; }
                    ...
                    {isLoading ? (
                      ...
                      questions.map(q => (
                        <div key={q.id} className="sb-q-card">
                          <div className="sb-q-topic">
                            {q.topicName}
                            <span className="sb-q-author">by {q.authorName}</span>
                          </div>
                          {q.questionText && <div className="sb-q-text">{q.questionText}</div>}
                          {q.imageUrl && <img src={q.imageUrl} alt="question" className="sb-q-img" loading="lazy" />}
                        </div>
                      ))
                    ) : (
